...
*/}
  ...
  const handlecheked = (event) => {
    setChecked(event.target.value);
     ...
     return(
      ...
      <h1 style={{fontSize:20,marginTop:160}}>Add <span style={{color:'#f5b342'}}>Upi</span> Details</h1>
  ...
  <div>
      ...
      <div style={{marginTop:20,backgroundColor:'#e3dada',justifyContent:'center',height:30,width:450,fontSize:13,display:'flex',alignItems:'center'}}>
     <LockIcon style={{width:12,height:12,alignItems:'center'}}/>
      <span>Your account is encrypted and 100% safe with us</span>
        </div>
        <Button style={{marginTop:50,width:'41%',backgroundColor:'#0ebbf0',color:'white'}} variant="contained" color="primary">
  Add Account
</Button>
      </div>
      </form>
