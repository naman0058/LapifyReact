...
export default function Repairingdrawer({props}) {
...
const handle=(e)=>{
  ...
  const list = (anchor) => (
    <form onSubmit={()=>submit()}>
      ...
      <h1 style={{fontSize:20}}>Repairing form</h1>
...
{/*      
  ...
  <Button  style={{width:'80%',marginLeft:45,marginBottom:20,marginTop:30,backgroundColor:'#0ebbf0',color:'white'}} variant="contained" color="primary">
  Submitform
</Button>
      </div>
      </form>
    ...
    <div>
      {[ 'right'].map((anchor) => (
        <React.Fragment key={anchor}>
          <labal labal="edit" onClick={toggleDrawer(anchor, true)}>Add repairing</labal>
