...
const SearchLaptop1 = () => {
    ...
    const fetch = () => {
        ...
        axios
            .get('https://lapify.in/api/all-brands?type=sell_laptop')
                        ...
                        <section >
                            ...
                            <div className="container">
                                ...
                                <div>
                                    ...
                                    <input type="search" style={{ maxWidth: "800px", marginLeft: 200,border:'white' }}
                            ...
                            <div style={{ marginTop: 10, display: "grid", fontFamily: "Montserrat" }}>
                                <p className="text-center"><strong style={{fontSize:28}}>Or choose a brand</strong></p>
                            </div>
                            ...
                            <div className="layout horizontal center-center base-bg">
                                <div className="container">
                                    <div className="row" style={{ cursor: "pointer" }}>
                                        ...
                                        {data.length !== 0 ? data.map(branddata =>
                                            <div className="col-md-3" className={classes.brand}>
                                                <a title={"dfbvdhgh"}>
                                                    <div>
                                                        <span>
                                                            <img style={{width:150,height:150}} className="img-fluid" onClick={() => { BrandHandler(branddata) }}
                                                                alt={branddata.name} src={'https://lapify.in/images/' + branddata.image} /></span>
                                                    </div>
                                                </a></div>
                                        ) : ""
